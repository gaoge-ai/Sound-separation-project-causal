...
def main():
    ...
    print("=" * 60)
    print("Calculate SDR/SI-SDR from Separated Files Only")
    print("=" * 60)
    print(f"Test wav dir: {args.wav_dir}")
    ...
    for sample_idx, sample_dir in enumerate(tqdm(sample_dirs, desc="Processing samples")):
        ...
        speech_es_path = os.path.join(args.results_dir, sample_name, 'speech_es.wav')
        music_es_path = os.path.join(args.results_dir, sample_name, 'music_es.wav')
        others_es_path = os.path.join(args.results_dir, sample_name, 'others_es.wav')
